...
public class IgnoreQueryFiltersEvaluatorTests
{
    ...
    [Fact]
    public void GetQuery_IgnoreQueryFiltersTrue_ReturnsIgnoreQueryFiltersQuery()
    {
        // Arrange
        ...
        Assert.True(query.IgnoreQueryFilters);
    }

    [Fact]
    public void GetQuery_IgnoreQueryFiltersFalse_ReturnsOriginalQueryable()
    {
        // Arrange
        var evaluator = IgnoreQueryFiltersEvaluator.Instance;
        var query = new Query<Company> { IgnoreQueryFilters = false };
