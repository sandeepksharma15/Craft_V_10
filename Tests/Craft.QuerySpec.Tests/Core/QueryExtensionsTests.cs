...
public class QueryExtensionsTests
{
    ...
    private class QueryStubWithoutSortOrderBuilder : IQuery<Company>
    {
        ...
        public SortOrderBuilder<Company>? SortOrderBuilder => null;
        public Func<IEnumerable<Company>, IEnumerable<Company>>? PostProcessingAction { get; set; }
        public SqlLikeSearchCriteriaBuilder<Company>? SqlLikeSearchCriteriaBuilder { get; } = new SqlLikeSearchCriteriaBuilder<Company>();
        public EntityFilterBuilder<Company>? EntityFilterBuilder { get; } = new EntityFilterBuilder<Company>();
        public void Clear() { }
