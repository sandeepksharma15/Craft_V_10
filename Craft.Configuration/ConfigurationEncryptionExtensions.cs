...
/// These methods provide backward compatibility with the previous implementation.
/// For new projects, consider using the Craft.Configuration.Extensions namespace.
/// </summary>
