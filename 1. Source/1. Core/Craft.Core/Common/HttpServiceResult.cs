...
/// <summary>
/// Alias for <see cref="ServiceResult{T}"/> for backward compatibility with HTTP service operations.
/// </summary>
...
public record HttpServiceResult<T> : IServiceResult
{
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Success() instead.")]
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Failure() instead.")]
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.NotFound() instead.")]
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Unauthorized() instead.")]
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Forbidden() instead.")]
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.InternalError() instead.")]
...
public static class ServiceResultExtensions
{
    ...
    /// <summary>
    /// Converts a HttpServiceResult to a ServiceResult.
    /// </summary>
    [Obsolete("HttpServiceResult is deprecated. Use ServiceResult<T> directly.")]
    public static ServiceResult<T> ToServiceResult<T>(this HttpServiceResult<T> result)
        => result.ToServiceResult();

    /// <summary>
    /// Converts a Result&lt;T&gt; to ServiceResult&lt;T&gt;.
    /// </summary>
    [Obsolete("Result<T> is deprecated. Use ServiceResult<T> directly.")]
    public static ServiceResult<T> ToServiceResult<T>(this Result<T> result)
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T> directly instead of HttpServiceResult<T>.")]
    ...
    #region Obsolete Result<T> Extensions for Backward Compatibility

    /// <summary>
    /// Asynchronously maps the result if successful.
    /// </summary>
    [Obsolete("Use ServiceResult<T> overload instead.")]
