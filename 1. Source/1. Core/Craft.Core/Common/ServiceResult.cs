...
public class ServiceResult : IServiceResult
{
    ...
    #region Obsolete Compatibility Methods

    /// <summary>
    /// Creates a successful result.
    /// </summary>
    [Obsolete("Use ServiceResult.Success() instead. This method will be removed in a future version.")]
    public static ServiceResult CreateSuccess() => Success();

    /// <summary>
    /// Creates a failed result.
    /// </summary>
    [Obsolete("Use ServiceResult.Failure() instead. This method will be removed in a future version.")]
    public static ServiceResult CreateFailure(string errorMessage, ErrorType errorType = ErrorType.Validation, int? statusCode = null)
        => Failure(errorMessage, errorType, statusCode);

    /// <summary>
    /// Creates a failed result.
    /// </summary>
    [Obsolete("Use ServiceResult.Failure() instead. This method will be removed in a future version.")]
    public static ServiceResult CreateFailure(List<string> errors, ErrorType errorType = ErrorType.Validation, int? statusCode = null)
        => Failure(errors, errorType, statusCode);
...
public class ServiceResult<T> : ServiceResult
{
    ...
    /// Creates a successful result with a value.
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Success() instead. This method will be removed in a future version.")]
    public static ServiceResult<T> CreateSuccess(T value) => Success(value);

    /// <summary>
    /// Creates a failed result.
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Failure() instead. This method will be removed in a future version.")]
    public static new ServiceResult<T> CreateFailure(string errorMessage, ErrorType errorType = ErrorType.Validation, int? statusCode = null)
        => Failure(errorMessage, errorType, statusCode);
    ...
    /// </summary>
    [Obsolete("Use ServiceResult<T>.Failure() instead. This method will be removed in a future version.")]
    public static new ServiceResult<T> CreateFailure(List<string> errors, ErrorType errorType = ErrorType.Validation, int? statusCode = null)
        => Failure(errors, errorType, statusCode);

    #endregion
}

#region Obsolete Type Aliases for Backward Compatibility

/// <summary>
/// Alias for <see cref="ServiceResult"/> for backward compatibility.
/// </summary>
[Obsolete("Use ServiceResult instead. This type alias will be removed in a future version.")]
public class Result : ServiceResult
{
    ...
    /// Creates a successful result.
    /// </summary>
    public static new Result CreateSuccess() => new(true);

    /// <summary>
    /// Creates a failed result.
    /// </summary>
    public static new Result CreateFailure(string errorMessage, ErrorType errorType = ErrorType.Validation, int? statusCode = null)
        => new(false, errorMessage, statusCode: statusCode, errorType: errorType);

    /// <summary>
    /// Creates a failed result.
    /// </summary>
    public static new Result CreateFailure(List<string> errors, ErrorType errorType = ErrorType.Validation, int? statusCode = null)
        => new(false, errors: errors, statusCode: statusCode, errorType: errorType);

    /// <summary>
    /// Creates a not found failure result.
    /// </summary>
    public static new Result NotFound(string message = "Resource not found")
        => new(false, message, statusCode: HttpStatusCodes.NotFound, errorType: ErrorType.NotFound);

    /// <summary>
    /// Creates an unauthorized failure result.
    /// </summary>
    public static new Result Unauthorized(string message = "Unauthorized access")
        => new(false, message, statusCode: HttpStatusCodes.Unauthorized, errorType: ErrorType.Unauthorized);

    /// <summary>
    /// Creates a forbidden failure result.
    /// </summary>
    public static new Result Forbidden(string message = "Access forbidden")
        => new(false, message, statusCode: HttpStatusCodes.Forbidden, errorType: ErrorType.Forbidden);
}

/// <summary>
/// Alias for <see cref="ServiceResult{T}"/> for backward compatibility.
/// </summary>
/// <typeparam name="T">The type of the value returned on success.</typeparam>
[Obsolete("Use ServiceResult<T> instead. This type alias will be removed in a future version.")]
