    ...
    where DataTransferT : class, IModel<TKey>
{
    ...
    Task<ServiceResult<T?>> AddAsync(ViewT model, CancellationToken cancellationToken = default);
    ...
    Task<ServiceResult<List<T>?>> AddRangeAsync(IReadOnlyCollection<ViewT> models, CancellationToken cancellationToken = default);
    ...
    Task<ServiceResult<bool>> DeleteAsync(TKey id, CancellationToken cancellationToken = default);
    ...
    /// <returns>A result indicating success or errors.</returns>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="models"/> is null.</exception>
    Task<ServiceResult<bool>> DeleteRangeAsync(IReadOnlyCollection<ViewT> models, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="model"/> is null.</exception>
    Task<ServiceResult<T?>> UpdateAsync(ViewT model, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="models"/> is null.</exception>
    Task<ServiceResult<List<T>?>> UpdateRangeAsync(IReadOnlyCollection<ViewT> models, CancellationToken cancellationToken = default);
}
